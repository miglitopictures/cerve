...
Para hospedar esses sites, sempre utilizo o GitHub Pages, pela gratuidade (para projetos pequenos) e pela facilidade no deploy. Aprendi, eventualmente, que o servidor do GH redireciona automaticamente para uma `404.html` quando uma rota não existe. Simular esse comportamento localmente no VS Code com o Live Server sempre foi um problema e deu muita dor de cabeça na hora de administrar as rotas dinâmicas.
